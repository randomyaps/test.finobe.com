	   ...
	   <div class='container'>
		  ...
		  <div id='navbar-collapse' class='collapse navbar-collapse'>
			 ...
			 <ul class='nav navbar-nav my-2 my-lg-0'>
				...
				<li data-animation='false' data-toggle='tooltip' data-placement='bottom' title='' class='nav-item nav-link n-money-text' data-original-title='". $dius ." " . $CurrencyName . "'><a><img src='" . $CurrencyIcon . "' alt='" . $CurrencyName . "' title='" . $CurrencyName . "' class='img-responsive align-middle' width='20' height='20'> ". $dius ."</a></li>
				<li class='nav-item dropdown'>
