                  ...
                  <div class="card">
                     ...
                     <div class="card-body">
						<form method="post" action="formregister.php">
                           ...
                           <div class="form-group row">
                              <label for="email_confirmation" class="col-md-3 col-form-label text-md-right">Confirm Email</label>
                              <div class="col-md-9">
                                 <input type="email" class="form-control" id="email_confirmation" name="email_confirmation" required="">
                                 <small id="emailHelp" class="form-text text-muted">We don't like email confirmation fields, but we don't like typos even more.</small>
                              </div>
                           </div>
                           <div class="form-group row">
