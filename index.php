...
switch(true){
	case ($FinobeToken):
		echo "<div class='container d-flex justify-content-center'><h1 class='mb-4 home-text'>Hi there, ". $userName ."</h1><p><a href='". $baseUrl ."/places' class='btn btn-success btn-lg mt-3 mr-2'>join a game ></a></p></div>";
		break;
	default:
